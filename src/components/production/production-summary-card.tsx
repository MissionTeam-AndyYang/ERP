import type { ProductionSummaryItem } from "@/types/production";

const toneStyles: Record<ProductionSummaryItem["tone"], string> = {
...
export function ProductionSummaryCard({ item }: ProductionSummaryCardProps) {
  return (

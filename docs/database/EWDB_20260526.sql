...
CREATE DATABASE IF NOT EXISTS `ai2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `ai2`;
...
CREATE TABLE IF NOT EXISTS `device` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_device_composite` (`no`, `hardwareId`)
...
CREATE TABLE IF NOT EXISTS `enterprise` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `no` VARCHAR(60) NOT NULL,
  `businessNo` VARCHAR(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `company` (
  ...
  `received_id` BIGINT UNSIGNED NULL,
  `paid_id` BIGINT UNSIGNED NULL,
  ...
  `creationTime` INT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_company_composite` (`no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `batchno_serialno_group` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_batchno_serialno_group_composite` (`group`,`batch_number`,`serialNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `rw_items` (
  ...
  `item_no` varchar(60) NOT NULL,  
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_rw_items_composite` (`item_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `inventory_delta` (
  ...
  `out_ref_id` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `inCount` FLOAT NULL,
  ...
  `creationTime` INT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_inventory_delta_composite` (`warehouse_no`, `date`, `timezone`, `specified_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `inventory_month_statistic` (
  ...
  `creationTime` INT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_inventory_month_statistic_composite` (`warehouse_no`, `date`, `timezone`,`category`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `inventory_item_month_statistic` (
  ...
  `creationTime` INT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_inventory_item_month_statistic_composite` (`warehouse_no`, `date`, `timezone`, `specified_no`, `specified_ref_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `purchase_request` (
  ...
  `creationTime` INT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_purchase_request_composite` (`no`,`product_order_no`,`item_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `order_payment` (
  ...
  `creationTime` INT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_order_payment_composite` (`no`, `date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `shipping_payment` (
  ...
  `date` INT NOT NULL,
  `arapType` INT NULL,
  `record_no` BIGINT UNSIGNED NULL,
  `refCategory` INT NULL,
  `ref_no` VARCHAR(60) NULL,
  -- FK candidate: `ref_no` -> product_order / purchase_order(`no`), needs_review,
  `ref_sub_no` VARCHAR(60) NULL,
...
CREATE TABLE IF NOT EXISTS `factory` (
  ...
  `comment` VARCHAR(128) NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_factory_composite` (`no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `aps_quantity_item` (
  ...
  `creationTime` INT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_aps_quantity_item_composite` (`product_order_no`, `output_item_no`, `oneProcess`, `secProcess`, `item_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `production_data_reuse` (
  ...
  `comment` VARCHAR(128) NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_production_data_reuse_composite` (`work_order_no`, `group`, `action`, `item_no`, `category`, `batch_number`, `serial_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `labor_wage` (
  ...
  `creationTime` INT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_labor_wage_composite` (`date`, `type`, `level`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `purchase_request` ADD CONSTRAINT `fk_purchase_request_item_no` FOREIGN KEY (`item_no`) REFERENCES `material` (`no`);
...
ALTER TABLE `shipping_payment` ADD CONSTRAINT `fk_shipping_payment_record_no` FOREIGN KEY (`record_no`) REFERENCES `shipping_record` (`id`);
ALTER TABLE `warehouse_payment` ADD CONSTRAINT `fk_warehouse_payment_record_no` FOREIGN KEY (`record_no`) REFERENCES `warehouse_record` (`id`);
...
ALTER TABLE `station` ADD CONSTRAINT `fk_station_production_line_no` FOREIGN KEY (`production_line_no`) REFERENCES `production_line` (`no`);

...
| Table | Purpose |
|----------|------|
| bom | 程式碼路徑中透過 ORM/服務邏輯使用此資料表 |
| sample_price | 程式碼路徑中透過 ORM/服務邏輯使用此資料表 |
...
2. 呼叫服務：CCBOMTree.retrieve、CLogger.log
3. 查詢或使用資料表：product_order
...
| Table | Purpose |
|----------|------|
| product_process | 程式碼路徑中透過 ORM/服務邏輯使用此資料表 |

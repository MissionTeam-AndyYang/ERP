...
const navItems: { labelKey: TranslationKey; icon: typeof Home; href: string }[] = [
  ...
  { labelKey: "nav.product360", icon: LayoutDashboard, href: "/product-360" },
  { labelKey: "nav.packaging", icon: PackageCheck, href: "/packaging" },
  { labelKey: "nav.manufacturingDefinition", icon: FileCheck2, href: "/manufacturing-definition" },
  ...
  { labelKey: "nav.routing", icon: Route, href: "/routing" },

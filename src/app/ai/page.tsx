    ...
    <AppLayout activePath="/ai" title="AI 中心 AI Insights Module">
      <div className="mx-auto max-w-[1440px] space-y-6">
        ...
        {filteredFlow.length > 0 ? (
          ...
          <SupportEmptyState title="沒有符合條件的 AI 流程" description="請調整搜尋關鍵字，或確認 AI 預警與建議資料是否已建立。" />
        )}
        <section className="grid gap-6 xl:grid-cols-[1fr_420px]">
          <div className="grid gap-4">
            {filteredInsights.length > 0 ? (
              ...
              <SupportEmptyState title="沒有符合條件的 AI 洞察" description="請調整搜尋關鍵字，或切回更寬的營運風險範圍檢查。" />
            )}
          </div>
          {filteredAssistantTasks.length > 0 ? (
            ...
            <SupportEmptyState title="沒有符合條件的 AI 待辦" description="目前搜尋條件下沒有需要優先 review 的 AI 建議項目。" />
          )}
        </section>
      </div>
    </AppLayout>

...
| payload.results[].process_order_no | String | process_order_no 回傳欄位 |  |
| payload.results[].group | String | group 回傳欄位 |  |
| payload.results[].time | Integer | time 回傳欄位 |  |
...
| payload.results[].serial_no | String | serial_no 回傳欄位 |  |
| payload.results[].valid_date | Integer | valid_date 回傳欄位 |  |
| payload.results[].valid_date_no | String | valid_date_no 回傳欄位 |  |
...
2. 組裝回傳 payload 欄位：payload.total、payload.count、payload.results[].id、payload.results[].work_order_no、payload.results[].process_order_no、payload.results[].group、payload.results[].time、payload.results[].action、payload.results[].item_no、payload.results[].item_name、payload.results[].category、payload.results[].itemSubCategory、payload.results[].batch_number、payload.results[].serial_no、payload.results[].valid_date、payload.results[].valid_date_no、payload.results[].unit、payload.results[].count、payload.results[].comment
...
| payload.total | Integer | 符合條件的總筆數 |  |
| payload.count | Integer | 本次回傳筆數 |  |
| payload.results[].workOrderDate | String | workOrderDate 回傳欄位 |  |
...
| payload.results[].totalExpectedCount | String | totalExpectedCount 回傳欄位 |  |
| payload.results[].batch_number | String | 批號 |  |
...
3. 組裝回傳 payload 欄位：payload.total、payload.count、payload.results[].workOrderDate、payload.results[].production_line_no、payload.results[].productionLineName、payload.results[].category、payload.results[].date、payload.results[].item_no、payload.results[].item_name、payload.results[].itemCategory、payload.results[].itemSubCategory、payload.results[].unit、payload.results[].totalExpectedCount、payload.results[].batch_number
